...
public class EventRequest {
    ...
    private int requesterUserId; // Stores the ID from the DB
    private String requesterName;  // Fetched via JOIN for display
    private String requesterEmail; // Fetched via JOIN for display
    // **** END NEW Fields ****


    public EventRequest() {} // Default constructor
    ...
    // **** NEW Getters/Setters for Requester Info ****
