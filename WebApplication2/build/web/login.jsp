...
<%-- JSTL core tag library - declared once at the top --%>
...
<head>
    ...
    <style>
        ...
        .login-container { background: white; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 40px 30px; max-width: 400px; width: 100%; text-align: center; margin-bottom: 20px; }
        .login-container h2 { margin-top: 0; margin-bottom: 20px; color: #444; }
        .login-container input[type="email"], .login-container input[type="password"] { width: 100%; padding: 12px; margin: 10px 0; border: 1px solid #ccc; border-radius: 4px; font-size: 14px; box-sizing: border-box; }
...
<div class="main-content">
    ...
    <div class="login-container">
        <h2>Admin Login</h2>
        <c:if test="${not empty param.adminError}"><div class="message error"><c:out value="${param.adminError}"/></div></c:if>
